...
- **Merging tests**: `tests/unit/test_merging_response.py` (28: happy/error/streaming/public API) + `test_merging_sql_fingerprint.py` (40 scenarios × 3 backends, fixture `merging_sql_fingerprint.json`).
