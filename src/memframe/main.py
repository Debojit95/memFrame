...
async def test():
    ...
    # mf = MemFrame(connection_type="remote", connection_params=pg_params,deep_cache=False)
    ...
    try:
        ...
        # ops1 = await mf.aupload_csv('/mnt/c/Users/ASUS/Documents/BAAS_KUBE/Neoanalytix/test_datasets/success/pollution_us_2000_2016.csv')
        ...
        result1 = ops1.head(2)
        # result1 = ops1.add('C','B')
        log_result(result1)
        print("*"*100)

        # result1 = ops1.mul('C','B')
        # log_result(result1)
        # print("*"*100)
