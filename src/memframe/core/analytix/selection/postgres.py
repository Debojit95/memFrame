...
Self-contained copy of all selection methods plus the PostgreSQL hooks
(information_schema introspection, passthrough asof serialization, and the
UNNEST(...) AS v(...) positional JOIN clause).
"""
