...
Self-contained copy of all selection methods plus the DuckDB-flavoured
hooks. No operational logic is inherited from the shared base except the
generic helpers (db access, quoting, column classification, ...).
"""
