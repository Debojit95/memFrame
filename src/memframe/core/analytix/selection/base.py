...
All operational methods (asof, at, iat, get, select_dtypes, iloc) are
defined once here on DuckDB-flavoured defaults; postgres.py / clickhouse.py
override six small dialect hooks (_list_columns_query,
_list_column_types_query, _column_name, _column_type, _serialize_asof_where,
_iloc_join_clause).
"""
...
class DataSelectionOps:
    ...
    # ------------------------------------------------------------------
    # Shared selection operations (hoisted verbatim; call the hooks above)
    # ------------------------------------------------------------------
